...
export type { WaterHeaterChildSwitch, WaterHeaterComposedDevice } from './waterHeaterDevice.js';
export { createWaterHeaterEndpoint, updateWaterHeaterEndpoint } from './waterHeaterDevice.js';
